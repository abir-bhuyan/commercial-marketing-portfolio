...
Built as a portfolio piece that explicitly bridges my Information Technology background to a Commercial & Marketing vacation role — taking a problem a marketing operations analyst would normally work in Excel and turning it into a self-explaining interactive tool.
...
- **B2B-calibrated.** The catalog and fit scores are tuned for industrial B2B services (Fugro's world). B2C plans run and produce sensible-looking output, but the channel set is missing the channels a real B2C marketer would use (Meta ads, influencer marketing, retail partnerships).
