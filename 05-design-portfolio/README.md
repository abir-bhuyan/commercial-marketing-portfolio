...
HR feedback on the application materials specifically asked for "a link showing your design skills" — recruiters seldom click into a GitHub folder of raw files. A landing page closes that gap: a single URL that loads in two seconds and shows the work as designed thumbnails rather than file lists.
